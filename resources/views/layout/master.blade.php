    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <form class="nav-link" method="POST" action="{{ route('logout') }}">
           @csrf
              <a href="route('logout')" onclick="event.preventDefault();this.closest('form').submit();"><i class="fas fa-fw fa-chart-area"></i><span class="nav-link pl-0"> Log out</span>
              </a>
        </form>
      </li>
          ...
          <section class="content">
            <nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
                <div class="pt-4 pb-1 border-t border-gray-200">
                    <div class="px-4">
                        <div class="font-large text-base text-gray-800">Have a nice day, {{ Auth::user()->name }}!</div>
                        <br>
                    </div>
                </div>
            </nav>
